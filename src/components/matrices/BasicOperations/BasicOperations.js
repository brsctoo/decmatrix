...
import style from "./BasicOperations.module.css";
...
export default function BasicOperations() {
    ...
    function handleSum() {
        const resultMatrix = addMatrices(matrixA.current, matrixB.current);
        return resultMatrix;
    }

    function handleSubtract() {
        const resultMatrix = subtractMatrices(matrixA.current, matrixB.current);
        return resultMatrix;
    }
